...
## Infrastructure
### Cloud Migration
- 4/10/26 - Phase 1 cutover
- 6/25/26 - Phase 2 data migration
- 9/15/26 - Phase 3 decommission legacy
### Network Refresh
- 4/26/26 - Core switch replacement
- 7/1/26 - Firewall upgrade
...
* [x] Finish Kubernetes basics tutorial
## Sprint Backlog
* [ ] JIRA-1234: Fix auth token refresh
* [ ] JIRA-1289: Add retry logic to API gateway
* [ ] JIRA-1301: Dashboard performance optimization
    - Profile slow queries
    - Add caching layer
* [x] JIRA-1199: Update logging format
* [ ] JIRA-1315: Implement rate limiting
